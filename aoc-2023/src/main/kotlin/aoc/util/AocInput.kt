...
fun getLeaderboards() {
    ...
    val fl1 = File(rootDir(2023), "src/main/resources/aoc/leaderboard.json")
    if (fl1.exists() && ts - fl1.lastModified() < MIN_LEADERBOARD_REFRESH_MILLIS)
        return

    val url1 = URL("https://adventofcode.com/2023/leaderboard/private/view/917872.json")
    readAocText(url1)?.let {
        println("Successfully downloaded leaderboard 1")
        fl1.writeText(it)
    }
    val fl2 = File(rootDir(2023), "src/main/resources/aoc/leaderboard2.json")
    val url2 = URL("https://adventofcode.com/2023/leaderboard/private/view/3240090.json")
