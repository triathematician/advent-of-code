...
AocRunner(3, info = {
        listOf("Leaderboard: 3:03/5:24", "Answers: 7903/2548")
    }, test = {
    "vJrwpWtwJgWrhcsFMMfFFhFp".let {
        "For example: $it has common letter ${it.commonLetter} and priority ${it.commonLetter.priority}"
    } },
    part1 = { "Sum of max priorities: " + input.sumOf { it.commonLetter.priority } },
    part2 = { "Sum of group badge priorities: " + input.chunked(3).sumOf { it.commonLetter.priority } }
).run()

val String.commonLetter: Char
    get() = halves[0].intersect(halves[1]).first()
